    ...
    <ul class="ty-account-info">
        {hook name="profiles:my_account_menu"}
            ...
            {if $auth.user_id}
                ...
                {/if}
                <li class="ty-account-info__item ty-dropdown-box__item"><a class="ty-account-info__a underlined" href="{"units.units&items_per_page=3"|fn_url}" rel="nofollow">{_("Отделы")}</a></li>
